...
{
    public class ErrorModule : IHttpModule, System.Web.SessionState.IRequiresSessionState
    {
        public ErrorModule()
        {
            //
        ...
        public void Redireccionar(HttpApplication httpApp, string mensaje)
        {
            httpApp.Context.Response.Redirect(httpApp.Context.Request.CreateAbsoluteUrl("~/error.aspx?error=" + mensaje), true);
        }
        public LogError WriteFileError(List<CustomExcepcion> listExc, System.Web.HttpApplication httpApp)
        {
            ...
            msjUser += "Si el problema persiste tome nota del siguiente código de error y comuniquese con la Dirección de Informática.$$$$";
            msjUser += "Código de error: " + codigoError + ".";
            LogError log = new LogError();
            try
            {
